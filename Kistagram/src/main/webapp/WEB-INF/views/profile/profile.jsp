						...
						<div class="profile0">
							<c:choose>
								<c:when test="${!empty profile_name }">
									<div class="profile1">
										<img class="profile2" id="View"	src="${path }/resources/profileimg-uploadfolder/${id }/${profile_name }" alt="Image">
									</div>
								</c:when>
								<c:otherwise>
									<div class="profile1">
										<img alt="프로필 사진 추가" id="View" class="profile2" src="https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png">
									</div>
								</c:otherwise>
							</c:choose>
						</div>
